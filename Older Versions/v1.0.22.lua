...
hDamage 		= nil
hGodMode 		= {VK_LCONTROL, VK_F2}
hDamageBoost 	= {VK_LCONTROL, VK_F3}
hDamageSource 	= nil
hNoModDamage	= nil
hPowerOutput 	= {VK_LCONTROL, VK_F4}
hEnergyUsage 	= {VK_LCONTROL, VK_F5}
hHDCharge 		= {VK_LCONTROL, VK_F6}
hSCCharge 		= {VK_LCONTROL, VK_F7}
hNoCooldown		= {VK_LCONTROL, VK_F8}
hNoMasslock		= nil
hHyFuelRange	= nil
hHyFuelUsage	= nil
hHyFuelInf		= nil
...
hFixedD 		= nil
hAutoD 			= nil
hManualD 		= {VK_LCONTROL, VK_F9}
hScoop			= nil
hHeatsink		= nil
hNoFuel			= nil
hNoWarning		= nil
hDebug 			= {VK_LCONTROL, VK_F10}
hOut			= {VK_LCONTROL, VK_F11}
...
table.damageCalc   		= { idx = 2, descr = "Damage", 					pat = "51 0F 57 C9 53 56", hotkey = hDamage, default = 1 }
table.godMode   		= { idx = 3, descr = "Invulnerability", 		pat = nil, func = nil, child = "damageCalc", hotkey = hGodMode, default = 1 }
table.damageBoost   	= { idx = 4, descr = "Increased Damage", 		pat = nil, func = nil, child = "damageCalc", hotkey = hDamageBoost, default = 1 }
table.damageSrc 		= { idx = 5, descr = "Only You", 				pat = "55 8B EC 83 E4 F0 81 EC ? ? ? ? 56 57 8B F9 89 7C 24 1C 8B 87 ? ? ? ?", child = "damageBoost", hotkey = hDamageSource, default = 1 }
table.noModDamage 		= { idx = 6, descr = "No Module Damage", 		pat = nil, func = nil, child = "damageCalc", hotkey = hNoModDamage, default = 1 }
table.powerOutput 		= { idx = 7, descr = "High Power Output", 		pat = "C7 43 ?? ?? ?? ?? ?? C7 43 ?? ?? ?? ?? ?? A1 ?? ?? ?? ?? 8D 73 50 8D 4B 04 89 06 C7 46 ?? ?? ?? ?? ?? 8B 43 04 FF 50 04 8B 10 8B C8 FF 12 56 8B C8 E8 ?? ?? ?? ?? C7 03 ?? ?? ?? ??", hotkey = hPowerOutput, default = 1 }
table.energyUsage 		= { idx = 8, descr = "No Energy Usage", 		pat = "83 EC 08 8B 44 24 0C 53 56 57 8D 3C 40 C1 E7 06 03 79 3C 89 4C 24 10 33 C0 8D 77 68 33 D2 33 DB 33 C9 F0 0F C7 0E F3 0F 10 4C 24 1C 33 D0 89 54", hotkey = hEnergyUsage, default = 1 }
table.moduleCaller   	= { idx = 9, descr = nil, 						pat = "D9 54 24 20 83 BF FC 00", hotkey = nil, default = 0 }
table.hullCaller   		= { idx = 10, descr = nil, 						pat = "D9 5C 24 2C 8B 47 6C 8D", hotkey = nil, default = 0 }
table.shieldCaller   	= { idx = 11, descr = nil, 						pat = "D9 54 24 10 83 BF 50 01", hotkey = nil, default = 0 }
table.hdCharge 			= { idx = 12, descr = "No HD Charge", 			pat = "E8 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 87 ? ? ? ?", hotkey = hHDCharge, default = 0 }
table.scCharge 			= { idx = 13, descr = "No SC Charge", 			pat = "D9 40 14 8D 87 ?? ?? ?? ??", hotkey = hSCCharge, default = 0 }
table.noCooldown		= { idx = 14, descr = "No Cooldown",			pat = "72 50 6A 64", hotkey = hNoCooldown, default = 0 }
table.noMasslock 		= { idx = 15, descr = "No Masslock", 			pat = "C7 87 ? ? ? ? ? ? ? ? 8B 8F ? ? ? ? C7 87 ? ? ? ? ? ? ? ? 8B 01 8D 54 24 78", hotkey = hNoMasslock, default = 0 }
table.hyper				= { idx = 16, descr = "HyperJump", 				pat = "F3 0F 10 4C 24 ? F3 0F 10 40 ? 0F 2F C8", hotkey = nil, safe = false, default = 0 } 
table.hyFuelRange		= { idx = 17, descr = "Extended HD Range",		pat = nil, func = nil, child = "hyper", hotkey = hHyFuelRange, safe = false, default = 0 }
table.hyFuelUsage		= { idx = 18, descr = "Less Fuel Usage",		pat = nil, func = nil, child = "hyper", hotkey = hHyFuelUsage, safe = false, default = 0 }
table.hyFuelInf			= { idx = 19, descr = "No Fuel Usage",			pat = nil, func = nil, child = "hyper", hotkey = hHyFuelInf, safe = false, default = 0 }
table.xmlParser   		= { idx = 20, descr = "XML Parser", 			pat = "56 8B 74 24 ?? 8B 86 ?? ?? ?? ?? 83 E8 ?? 0F 84 ?? ?? ?? ?? 48 0F 84 ?? ?? ?? ?? 57 8B 7C 24 ?? C7 86 ?? ?? ?? ?? ?? ?? ?? ?? 85 FF 0F 85", hotkey = nil, default = 0 }
table.enMine			= { idx = 21, descr = "Enh. Mining", 			pat = nil, child = "xmlParser", hotkey = hMining, safe = false, default = 0 }
table.mdCSV   			= { idx = 22, descr = "CSV", 					pat = nil, func = nil, child = "xmlParser", hotkey = hCSV, default = 0 }
table.mdBPC   			= { idx = 23, descr = "BPC", 					pat = nil, func = nil, child = "xmlParser", hotkey = hBPC, default = 0 }
table.mdTDP				= { idx = 24, descr = "TDP", 					pat = nil, func = nil, child = "xmlParser", hotkey = hTDP, default = 0 }
table.mdFixedD   		= { idx = 25, descr = "Fixed Dump", 			pat = nil, func = nil, child = "xmlParser", hotkey = hFixedD, default = 0 }
table.mdAutoD  			= { idx = 26, descr = "Auto Dump", 				pat = nil, func = nil, child = "xmlParser", hotkey = hAutoD, default = 0 }
table.mdManualD  		= { idx = 27, descr = "Manual Dump", 			pat = nil, func = nil, child = "xmlParser", hotkey = hManualD, default = 0 }
table.writeFile 		= { idx = 28, descr = nil, 						pat = nil, func = "KERNEL32.WriteFile", hotkey = nil, default = 0 }
table.scoop   			= { idx = 29, descr = "Instant scooping",		pat = "80 BC 24 ? ? ? ? ? 0F 84 ? ? ? ? 8B 5C 24 14", hotkey = hScoop, default = 0 }
table.hsTimer			= { idx = 30, descr = "Inf. Heatsink Duration", pat = "F3 0F 10 44 24 ? F3 0F 58 83 ? ? ? ?",  hotkey = hHeatsink, default = 0 }
table.noFuel			= { idx = 31, descr = "No Fuel Usage (flight)",	pat = "C7 44 24 ? ? ? ? ? C6 43 58 01",  hotkey = hNoFuel, default = 0 }
table.amFrezMag			= { idx = 32, descr = "Freeze Magazine",		pat = "8b 45 00 4b 85 C0 74 ?? 33 C5 74 ?? 29 48 ?? 0F B7 3D ?? ?? ?? ?? 0F B7 35", hotkey = hFrezMag, safe = false, default = 0 }
table.amFrezSs			= { idx = 33, descr = "Freeze Single Shots",	pat = "51 53 55 8B E9 56 8D 75 60",  hotkey = hFrezSS, safe = false, default = 0 }
table.noWarning			= { idx = 34, descr = "No Warning",				pat = nil, func = nil, hotkey = hNoWarning, default = 0, on = false }
table.debug 			= { idx = 35, descr = "Debug Mode", 			pat = nil, func = nil, hotkey = hDebug, default = 0 }
table.disableOutput		= { idx = 36, descr = "Disable Console Output",	pat = nil, func = nil, hotkey = hOut, default = 0, on = false }
table.numOfBreakpoints	= { idx = 37, descr = "H-Breakpoints: ", 		pat = nil, func = nil, hotkey = nil, default = 0 }
...
----------------------------------------------------------------------------------------------
	...
	autoAssemble([[
		alloc(g_damageModifier,4)
		registersymbol(g_damageModifier)
	]])
	 
	writeFloat(getAddress("g_damageModifier"), damageModifier)
	 
	autoAssemble([[
		globalalloc(return0, 64)
		globalalloc(damageboost, 64)
		...
		damageboost:
			fld dword ptr [g_damageModifier]
			ret 4
	]])
	 
	return0 = getAddress("return0")
	damageboost = getAddress("damageboost")
...
----------------------------------------------------------------------------------------------
		elseif (EIP == table['damageCalc'].addr) then
			...
			if (caller == table['hullCaller'].addr) then
				if (npcFlag == 0 and authFlag == 1 and table['godMode'].on == true) then
					if (return0 ~= nil) then EIP = return0; end
					printDBG(string.format("Hull Damage nullified! - Incoming Pointer: 0x%X - Caller: 0x%X", incomingPointer, caller))
	 
				elseif (npcFlag == 1 and table['damageBoost'].on == true and isPlayerDamage == 1) then
					if (damageboost ~= nil) then EIP = damageboost; end
					printDBG(string.format("Hull Damage set to approx. %.2f - Incoming Pointer: 0x%X - Caller: 0x%X", damageModifier, incomingPointer, caller))
				end
			...
			elseif (caller == table['shieldCaller'].addr) then
				if (npcFlag == 0 and authFlag == 1 and table['godMode'].on == true) then
					if (return0 ~= nil) then EIP = return0; end
					printDBG(string.format("Shield Damage nullified! - Incoming Pointer: 0x%X - Caller: 0x%X", incomingPointer, caller))
	 
				elseif (npcFlag == 1 and table['damageBoost'].on == true and isPlayerDamage == 1) then
					if (damageboost ~= nil) then EIP = damageboost; end
					printDBG(string.format("Shield Damage set to approx. %.2f - Incoming Pointer: 0x%X - Caller: 0x%X", damageModifier, incomingPointer, caller))
				end
	 
			-- When module damage is done
			elseif (caller == table['moduleCaller'].addr) then
				if (npcFlag == 0 and authFlag == 1 and table['noModDamage'].on == true) then
					if (return0 ~= nil) then EIP = return0; end
					printDBG(string.format("Module Damage nullified! - Incoming Pointer: 0x%X - Caller: 0x%X", incomingPointer, caller))
	 
				elseif (npcFlag == 1 and table['damageBoost'].on == true and isPlayerDamage == 1) then
					if (damageboost ~= nil) then EIP = damageboost; end
				printDBG(string.format("Module Damage set to approx. %.2f - Incoming Pointer: 0x%X - Caller: 0x%X", damageModifier, incomingPointer, caller))
				end
