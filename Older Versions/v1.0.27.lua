----------------------------------------------------------------------------------------------
-- Last Update: 16/05/15
    gameVersion = "v1.2.07"
    scriptVersion = "v1.0.27"
...
table.damageBoost   	= { idx = 3, descr = "Multiply Damage", 		pat = nil, func = nil, child = "damageCalc", hotkey = hDamageBoost, default = 1 }
...
table.energy	 		= { idx = 10, descr = "Energy", 				pat = "83 EC 08 8B 44 24 0C 53 56 57 8D 3C 40 C1 E7 06 03 79 3C 89 4C 24 10 33 C0 8D 77 68 33 D2 33 DB 33 C9 F0 0F C7 0E F3 0F 10 4C 24 1C 33 D0 89 54", hotkey = nil, default = 1 }
table.enRedUse			= { idx = 11, descr = "Reduced Usage",			pat = nil, func = nil, child = "energy", hotkey = hEnRedUse, default = 1 }
table.enNoUse			= { idx = 12, descr = "No Usage",				pat = nil, func = nil, child = "energy", hotkey = hEnNoUse, default = 0 }
table.moduleCaller   	= { idx = 13, descr = nil, 						pat = "D9 54 24 20 83 BF FC 00", hotkey = nil, default = 0 }
table.hullCaller   		= { idx = 14, descr = nil, 						pat = "D9 5C 24 2C 8B 47 6C 8D", hotkey = nil, default = 0 }
table.shieldCaller   	= { idx = 15, descr = nil, 						pat = "D9 54 24 10 83 BF 50 01", hotkey = nil, default = 0 }
table.hdCharge 			= { idx = 16, descr = "No HD Charge", 			pat = "E8 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 87 ? ? ? ?", hotkey = hHDCharge, default = 0 }
table.scCharge 			= { idx = 17, descr = "No SC Charge", 			pat = "D9 40 14 8D 87 ?? ?? ?? ??", hotkey = hSCCharge, default = 0 }
table.noCooldown		= { idx = 18, descr = "No Cooldown",			pat = "72 50 6A 64", hotkey = hNoCooldown, default = 0 }
table.noMasslock 		= { idx = 19, descr = "No Masslock", 			pat = "C7 87 ? ? ? ? ? ? ? ? 8B 8F ? ? ? ? C7 87 ? ? ? ? ? ? ? ? 8B 01 8D 54 24 78", hotkey = hNoMasslock, default = 0 }
table.hyper				= { idx = 20, descr = "HyperJump", 				pat = "F3 0F 10 4C 24 ? F3 0F 10 40 ? 0F 2F C8", hotkey = nil, safe = false, default = 0 } 
table.hyFuelRange		= { idx = 21, descr = "Extended HD Range",		pat = nil, func = nil, child = "hyper", hotkey = hHyFuelRange, safe = false, default = 0 }
table.hyFuelUsage		= { idx = 22, descr = "Less Fuel Usage",		pat = nil, func = nil, child = "hyper", hotkey = hHyFuelUsage, safe = false, default = 0 }
table.hyFuelInf			= { idx = 23, descr = "No Fuel Usage",			pat = nil, func = nil, child = "hyper", hotkey = hHyFuelInf, safe = false, default = 0 }
table.xmlParser   		= { idx = 24, descr = "XML Parser", 			pat = "56 8B 74 24 ?? 8B 86 ?? ?? ?? ?? 83 E8 ?? 0F 84 ?? ?? ?? ?? 48 0F 84 ?? ?? ?? ?? 57 8B 7C 24 ?? C7 86 ?? ?? ?? ?? ?? ?? ?? ?? 85 FF 0F 85", hotkey = nil, default = 0 }
table.enMine			= { idx = 25, descr = "Enh. Mining", 			pat = nil, child = "xmlParser", hotkey = hMining, safe = false, default = 0 }
table.mdCSV   			= { idx = 26, descr = "CSV", 					pat = nil, func = nil, child = "xmlParser", hotkey = hCSV, default = 0 }
table.mdBPC   			= { idx = 27, descr = "BPC", 					pat = nil, func = nil, child = "xmlParser", hotkey = hBPC, default = 0 }
table.mdTDP				= { idx = 28, descr = "TDP", 					pat = nil, func = nil, child = "xmlParser", hotkey = hTDP, default = 0 }
table.mdFixedD   		= { idx = 29, descr = "Fixed Dump", 			pat = nil, func = nil, child = "xmlParser", hotkey = hFixedD, default = 0 }
table.mdAutoD  			= { idx = 30, descr = "Auto Dump", 				pat = nil, func = nil, child = "xmlParser", hotkey = hAutoD, default = 0 }
table.mdManualD  		= { idx = 31, descr = "Manual Dump", 			pat = nil, func = nil, child = "xmlParser", hotkey = hManualD, default = 0 }
table.writeFile 		= { idx = 32, descr = nil, 						pat = nil, func = "KERNEL32.WriteFile", hotkey = nil, default = 0 }
table.scoop   			= { idx = 33, descr = "Instant scooping",		pat = "80 BC 24 ? ? ? ? ? 0F 84 ? ? ? ? 8B 5C 24 14", hotkey = hScoop, default = 0 }
table.hsTimer			= { idx = 34, descr = "Inf. Heatsink Duration", pat = "F3 0F 10 44 24 ? F3 0F 58 83 ? ? ? ?",  hotkey = hHeatsink, default = 0 }
...
table.amFrezSs			= { idx = 37, descr = "Freeze Single Shots",	pat = "51 53 55 8B E9 56 8D 75 60",  hotkey = hFrezSS, safe = false, default = 0 }
		...
		elseif (EIP == table['damageCalc'].addr) then
			...
			if (caller == table['shieldCaller'].addr) then
				...
				if ((npcFlag == 0) and (authFlag == 1)) then
					local curShieldValPtr = shieldModulePtr + 856
					local maxShieldValPtr = shieldModulePtr + 0x338
					local xoredCurShieldVal = bXor(readAddress(curShieldValPtr), readAddress(curShieldValPtr + 4))
					local xoredMaxShieldVal = bXor(readAddress(maxShieldValPtr), readAddress(maxShieldValPtr + 4))
					local curShieldVal = hex2float(xoredCurShieldVal)
					local maxShieldVal = hex2float(xoredMaxShieldVal)
					
					--printDBG(string.format("Payer Shield | shieldModulePtr: 0x%X - hullRefPtr: 0x%X - hullPtr: 0x%X - Current Shield Value: %.2f - Max Shield Value: %.2f", shieldModulePtr, hullRefPtr, hullPtr, curShieldVal, maxShieldVal))
					
					if (table['noShieldD'].on == true) then
						writeFloat(result, 0.0)
	 				
					 elseif (table['someShieldD'].on == true) then
					 	if (curShieldVal > maxShieldVal * 0.5) then
							writeFloat(result, 0.15)
						
						elseif (curShieldVal > maxShieldVal * 0.25) then
				...
				elseif ((npcFlag == 1) and (table['damageBoost'].on == true) and (isPlayerDamage == 1)) then
					...
					--printDBG(string.format("npc: %s - auth %s - playerd: %s", tostring(npcFlag), tostring(authFlag), tostring(isPlayerDamage)))
				end 
			
			-- When Hull damage is done
			elseif (caller == table['hullCaller'].addr) then
				local hullPtr = pthis - 0x98 + 0x6C
				local npcFlag = isNPC(hullPtr)
				local authFlag = isAUTH(hullPtr)
			...
			elseif (caller == table['moduleCaller'].addr) then
				local hullPtr = readAddress(incomingPointer + 0x124) - 0x028
				local npcFlag = isNPC(hullPtr)
				local authFlag = isAUTH(hullPtr)
				
				--printDBG(string.format("Module | hullPtr: 0x%X", hullPtr))
