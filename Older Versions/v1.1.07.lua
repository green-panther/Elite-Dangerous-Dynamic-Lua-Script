...
table.WinHttpOpen   	= { descr = "LogOffSky", 				func = "WINHTTP.WinHttpOpenRequest", hotkey = hLogOffSky, swb = 1, default = 1 }
table.damageCalc   		= { descr = "Damage", 					sig = "D8 46 08 D8 46 0C", offs = 18, hotkey = hDamage, default = 1 }
table.damageBoost   	= { descr = "Multiply Damage", 			parent = "damageCalc", hotkey = hDamageBoost, default = 1 }
table.damageSrc 		= { descr = "Only You", 				sig = "55 8B EC 83 E4 F0 81 EC ? ? ? ? 56 8B F1 57 8B 86 ? ? ? ? 8D 8E ? ? ? ?", parent = "damageBoost", hotkey = hDamageSource, default = 1 }
table.noHullD 			= { descr = "No Hull Damage", 			parent = "damageCalc", hotkey = hNoHullD, default = 1 }
table.someShieldD 		= { descr = "Some Shield Damage", 		parent = "damageCalc", hotkey = hSomeShieldD, default = 1 }
table.noShieldD 		= { descr = "No Shield Damage", 		parent = "damageCalc", hotkey = hNoShieldD, default = 0 }
table.noModD	 		= { descr = "No Module Damage", 		parent = "damageCalc", hotkey = hNoModD, default = 1 }
table.powerOutput 		= { descr = "High Power Output", 		sig = "C7 43 ? ? ? ? ? C7 43 ? ? ? ? ? A1 ? ? ? ? 8D 73 50 8D 4B 04", hotkey = hPowerOutput, default = 1 }
table.energy	 		= { descr = "Energy", 					sig = "83 EC 08 8B 44 24 0C 53 56 57", hotkey = nil, default = 1 }
table.enRedUse			= { descr = "Reduced Usage",			parent = "energy", hotkey = hEnRedUse, default = 1 }
table.enNoUse			= { descr = "No Usage",					parent = "energy", hotkey = hEnNoUse, default = 0 }
table.moduleCaller   	= { descr = nil, 						sig = "D9 54 24 20 83 BF ? ? ? ? ?", hotkey = nil, default = 0 }
table.hullCaller   		= { descr = nil, 						sig = "D9 5C 24 2C 8B 47 6C", hotkey = nil, default = 0 }
table.shieldCaller   	= { descr = nil, 						sig = "D9 54 24 24 83 BF ? ? ? ? ?", hotkey = nil, default = 0 }
table.hdCharge 			= { descr = "No HD Charge", 			sig = "E8 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 87 ? ? ? ? E9 ? ? ? ?", hotkey = hHDCharge, default = 0 }
table.scCharge 			= { descr = "No SC Charge", 			sig = "D9 40 14 8D 97 ? ? ? ?", hotkey = hSCCharge, default = 0 }
table.noCooldown		= { descr = "No Cooldown",				patch = {"72 50 6A 64", "EB"}, hotkey = hNoCooldown, default = 1 }
table.noMasslock 		= { descr = "No Masslock", 				sig = "C7 87 ? ? ? ? ? ? ? ? 8B 8F ? ? ? ? C7 87 ? ? ? ? ? ? ? ? 8B 01 8B 40 24", hotkey = hNoMasslock, default = 0 }
table.hyper				= { descr = "HyperJump", 				sig = "F3 0F 10 4C 24 ? F3 0F 10 40 ? 0F 2F C8", hotkey = nil, safe = false, default = 0 } 
table.hyFuelRange		= { descr = "Extended HD Range",		parent = "hyper", hotkey = hHyFuelRange, safe = false, default = 0 }
table.hyFuelUsage		= { descr = "Less Fuel Usage",			parent = "hyper", hotkey = hHyFuelUsage, safe = false, default = 0 }
table.hyFuelInf			= { descr = "No Fuel Usage",			parent = "hyper", hotkey = hHyFuelInf, safe = false, default = 0 }
table.xmlParser   		= { descr = "XML Parser", 				sig = "56 8B 74 24 08 8B 86 ? ? ? ? 83 E8 02 0F 84 ? ? ? ? 48 0F 84 ? ? ? ? 57", hotkey = nil, default = 0 }
table.enMine			= { descr = "Enh. Mining", 				parent = "xmlParser", hotkey = hMining, safe = false, default = 0 }
table.mdCSV   			= { descr = "CSV", 						parent = "xmlParser", hotkey = hCSV, default = 0 }
table.mdBPC   			= { descr = "BPC", 						parent = "xmlParser", hotkey = hBPC, default = 0 }
table.mdTDP				= { descr = "TDP", 						parent = "xmlParser", hotkey = hTDP, default = 0 }
table.mdFixedD   		= { descr = "Fixed Dump", 				parent = "xmlParser", hotkey = hFixedD, default = 0 }
table.mdAutoD  			= { descr = "Auto Dump", 				parent = "xmlParser", hotkey = hAutoD, default = 0 }
table.mdManualD  		= { descr = "Manual Dump", 				parent = "xmlParser", hotkey = hManualD, default = 0 }
table.writeFile 		= { descr = nil, 						func = "KERNEL32.WriteFile", hotkey = nil, swb = 1, default = 1 }
table.scoop   			= { descr = "Instant scooping",			patch = {"74 18 6A 00 51 8D 44 24 20 8B CC 50 E8 ?? ?? ?? ?? 8B 46 28", "90 90"}, hotkey = hScoop, default = 1 }
table.hsTimer			= { descr = "Inf. Heatsink Duration", 	sig = "F3 0F 10 83 ? ? ? ? F3 0F 58 44 24 ? F3 0F 11 83 ? ? ? ?",  hotkey = hHeatsink, default = 0 }
table.noFuel			= { descr = "No Fuel Usage (flight)",	sig = "C7 44 24 ? ? ? ? ? C6 43 58 01",  hotkey = hNoFuel, default = 0 }
table.amFrezSs			= { descr = "Freeze Ammo",				patch = {"2B DE 85 C0 74 07", "90 90"}, hotkey = hAmmo, safe = false, default = 0 }
table.noWarning			= { descr = "No Warning",				hotkey = hNoWarning, default = 0, on = false }
table.debug 			= { descr = "Debug Mode", 				hotkey = hDebug, default = 1 }
table.disableOutput		= { descr = "Disable Console Output",	hotkey = hOut, default = 0, on = false }
table.numOfBreakpoints	= { descr = "H-Breakpoints: ", 			hotkey = nil, default = 0 }
...
function attachED(timer)
	if ((detached == true and terminated == true)) then
		...
		AOBSwap('39 07 74 0A 89 0B C6 02 00 C6 44 24 ? ?', '90 90', nil, true, false, 'hashing', false)
		printDual("Patched Hashing!")
		
		AOBSwap('FF D0 8B 4C 24 34 8B 54 24 48', '90 90', nil, true, false, 'call', false)
